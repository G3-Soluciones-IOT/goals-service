package pe.edu.upc.goals_service.shared.infrastructure.persistence.jpa.configuration;
...
public class FlywayMigrationConfiguration {
    ...
    private static final String FLYWAY_MIGRATOR_BEAN_NAME = "goalsFlywayMigrator";
    ...
    public InitializingBean goalsFlywayMigrator(Flyway flyway) {
        return () -> {
    ...
    @Bean
    public static BeanFactoryPostProcessor goalsEntityManagerFactoryDependsOnFlyway() {
        return beanFactory -> {
